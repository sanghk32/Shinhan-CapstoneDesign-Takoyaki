...
<body>
	...
	String extidStr = request.getParameter("extid"); // 파라미터 값을 문자열로 얻음
	...
	try {
		...
		String sqlQuery = "SELECT * FROM extDetail where extid = ?";
    ...
    %>
    <form id="bookmarkForm" method="POST" action="extBookmark.jsp">
...
document.addEventListener("DOMContentLoaded", function() {
    ...
    document.getElementById('extid').value = extid;
});
