...
try {
    ...
    if (request.getParameter("rating") != null) {
        ...
        pstmt = conn.prepareStatement("SELECT * FROM contUserBookmark WHERE id = ? AND contid = ?");
        ...
        if (resultSet.next()) {
            ...
            pstmt = conn.prepareStatement("UPDATE contUserBookmark SET rating = ? WHERE id = ? AND contid = ?");
            ...
            pstmt = conn.prepareStatement("INSERT INTO contUserBookmark (id, contid, name, category, agent, rating) VALUES (?, ?, ?, ?, ?, ?)");
            pstmt.setString(1, id);
            pstmt.setString(2, contid);
